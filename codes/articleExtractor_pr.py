...
class articleExtractor(HTMLParser):
	def reset(self):
		...
		self.tags = set(["publisher","fulltext","document","pub_title","full_text","pub_date","author","abstract","title","document_url","pq_doc_id", "pub_title", "document_url", "abstract", "title","database", "query","pub_date","document_id","source", "script"])
